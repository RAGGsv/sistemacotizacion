...
<page backtop="15mm" backbottom="15mm" backleft="15mm" backright="15mm" style="font-size: 12pt; font-family: arial" >
        ...
        <table class="page_footer">
            <tr>
                ...
                <td style="width: 50%; text-align: right">
                    &copy; <? echo "Herramientas de productividad -- "; echo  $anio=date('Y'); ?>
                </td>
            </tr>
        </table>
    </page_footer>
    ...
    <table cellspacing="0" style="width: 100%; text-align: left; font-size: 10pt;">
		<tr>
		<td style="width:50%; "><strong>Dirección:</strong> <br>Santa Ana, El Salvador C.A.<br> Teléfono.: (503)2402-0000</td>
    ...
    <table cellspacing="0" style="width: 100%; text-align: left; font-size: 11pt;">
        ...
        <table cellspacing="0" style="width: 100%; text-align: left;font-size: 11pt">
        <tr>
             <td style="width:100%; ">Nos es grato presentar nuestra oferta que esperamos sea de su conformidad.</td><br>
			 		 
        </tr>
		<tr>
            
			 <td style="width:100%; ">Quedamos a su disposicion.</td>
